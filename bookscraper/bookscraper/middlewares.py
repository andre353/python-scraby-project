...
class ScrapeOpsFakeBrowserHeaderMiddleware:
    ...
    def __init__(self, settings):
        ...
        self.scrapeops_endpoint = os.getenv('SCRAPEOPS_FAKE_USER_AGENT_ENDPOINT', 'http://headers.scrapeops.io/v1/user-agents?')
        self.scrapeops_fake_user_agents_active = os.getenv('SCRAPEOPS_FAKE_USER_AGENT_ENABLED', True)
    ...
    def _get_headers_list(self):
        ...
        if self.scrapeops_num_results is not None:
            payload['num_headers'] = self.scrapeops_num_results
    ...
    def _get_random_browser_header(self):
        ...
        # print('--------PRINT-----------')
        # print(self.headers_list[random_index])
